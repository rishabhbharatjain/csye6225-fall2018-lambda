echo " "
echo "---Creating AutoScaling Application Stack---"
echo " "
echo "Enter Keyname"
read keyname
echo " "
echo "Enter the name for autoscaling application stack"
read stack_name
echo " "
